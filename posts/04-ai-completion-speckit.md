---
title: "AI 개발 방법론 4 - 완성, SpecKit과 그 너머"
date: "2025-11-17"
...
> 이전 편: [AI 개발 방법론 3 - 돌파구, 순차적 문서 작성](03-ai-breakthrough-sequential.md)
...
그래서 만들기로 했습니다. 바이브 코딩을 더 잘하게 하는 프레임워크입니다.

### 컨셉

스펙 주도 개발입니다. 사용자가 "소셜 로그인 기능 있는 TODO 앱 만들고 싶어"라고 입력하면 AI가 요구사항을 추론해서 필요한 것들을 파악하고, 사용자에게 불명확한 부분을 질문하며, 적합한 기술 스택을 결정하고, 명확한 기능 명세를 작성한 뒤, 구현 계획을 수립하고 실제 코딩을 시작합니다. 모든 과정이 자동화됩니다.
