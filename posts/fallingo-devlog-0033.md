...
- **GitHub Actions에 태그 push 권한 추가**: 태그 권한 추가<br />
- **GitHub API 업로드 에러 처리 개선**: 에러 처리 개선<br />
- **마지막 블로그 이후 커밋만 수집하도록 수정**: 중복 방지

### 블로그 시스템 재구성 (6개 커밋)
- **블로그 제목 및 파일명을 커밋 기반으로 변경**: 커밋 기반 전환<br />
- **블로그 자동화 시스템을 커밋 기반으로 완전 전환**: 완전 전환<br />
- **블로그 제목에 커밋 범위(해시) 추가**: 해시 추가<br />
- **블로그 작성 스타일에 존댓말 사용 명시**: 존댓말 명시<br />
- **블로그 프롬프트를 현실적으로 개선**: 프롬프트 개선<br />
...
- **블로그 자동화**: 주간 기반 → 커밋 기반 완전 전환<br />
- **스타일**: 존댓말 사용, Dev Log 형식<br />
- **안정성**: GitHub Actions 권한, 에러 처리 개선<br />
